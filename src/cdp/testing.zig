...
pub fn context() !TestContext {
    // std.c.socketpair / AF_LOCAL are unavailable on native Windows. CDP unit
    // tests using this Unix-only in-process transport skip there; browser HTML
    // tests and the native CDP server use their normal Windows socket paths.
