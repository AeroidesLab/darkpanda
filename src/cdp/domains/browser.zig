...
const REVISION = "@" ++ ClientProfile.chrome149_chromium_revision;
...
const CDP_USER_AGENT = ClientProfile.get(.chrome149).user_agent;
const PRODUCT = "Chrome/" ++ ClientProfile.chrome149_full_version;

const JS_VERSION = ClientProfile.chrome149_v8_version;
