  ...
  try {
    if (cmd.kind === 'basic') {
      ...
      postMessage({
        ...
        origin_is_epoch: performance.timeOrigin > 1_000_000_000_000,
        clock_delta_ms: Date.now() - performance.timeOrigin - t,
        supported_types: supportedTypes,
        supported_types_same_object:
          supportedTypes === PerformanceObserver.supportedEntryTypes,
        supported_types_frozen: Object.isFrozen(supportedTypes),
        supported_types_extensible: Object.isExtensible(supportedTypes),
      });
      return;
    }
