...
fn initWithTrusted(arena: Allocator, typ: String, _opts: ?Options, trusted: bool, frame: *Frame) !*FocusEvent {
    ...
    if (trusted) {
        // Programmatic focus and user-input focus both create trusted events,
        // and Blink supplies the target document's Window as UIEvent.view.
        // sourceCapabilities is intentionally left to the focus initiator:
        // HTMLElement.focus() uses null while mouse focus supplies its device.
