...
fn initWithTrusted(typ: []const u8, _opts: ?Options, trusted: bool, frame: *Frame) !*WheelEvent {
    ...
    const event = try frame._factory.mouseEvent(
        ...
        MouseEvent{
            ...
            ._proto = undefined,
            ._screen_x = MouseEvent.compatibilityCoordinate(opts.screenX),
            ._screen_y = MouseEvent.compatibilityCoordinate(opts.screenY),
            ._client_x = MouseEvent.compatibilityCoordinate(opts.clientX),
            ._client_y = MouseEvent.compatibilityCoordinate(opts.clientY),
            ...
            ._offset_x = MouseEvent.constructorOffsetCoordinate(opts.clientX),
            ._offset_y = MouseEvent.constructorOffsetCoordinate(opts.clientY),
