...
pub fn init(
    ...
    return .{
        ...
        ._observed_width = canvas.getWidth(),
        ._observed_height = canvas.getHeight(),
    };
}

fn resetDrawingState(self: *OffscreenCanvasRenderingContext2D) void {
...
/// Called by OffscreenCanvas's dimension setters. This is deliberately
/// unconditional because `canvas.width = canvas.width` also resets the bitmap
/// and context state in Chrome.
pub fn onCanvasResize(self: *OffscreenCanvasRenderingContext2D, width: u32, height: u32) void {
...
fn syncCanvasDimensions(self: *OffscreenCanvasRenderingContext2D) void {
    ...
    self._canvas.resizeBitmapStorage(width, height);
...
fn pushFillStyle(self: *OffscreenCanvasRenderingContext2D, owned: *adapter.OwnedSurface, surface: *CanvasSurface) !void {
...
fn pushStrokeStyle(self: *OffscreenCanvasRenderingContext2D, owned: *adapter.OwnedSurface, surface: *CanvasSurface) !void {
...
fn applyStateToBackend(self: *OffscreenCanvasRenderingContext2D, owned: *adapter.OwnedSurface, surface: *CanvasSurface) !void {
...
fn backend(self: *OffscreenCanvasRenderingContext2D) ?*adapter.OwnedSurface {
...
pub fn getFillStyle(self: *OffscreenCanvasRenderingContext2D, exec: *Execution) !StyleReturn {
    self.syncCanvasDimensions();
    switch (self._fill_style) {
        .color => |c| {
...
pub fn setFillStyle(self: *OffscreenCanvasRenderingContext2D, value: StyleArg, _: *Execution) !void {
    self.syncCanvasDimensions();
    switch (value) {
        .string => |s| {
...
pub fn getStrokeStyle(self: *OffscreenCanvasRenderingContext2D, exec: *Execution) !StyleReturn {
    self.syncCanvasDimensions();
    switch (self._stroke_style) {
        .color => |c| {
...
pub fn setStrokeStyle(self: *OffscreenCanvasRenderingContext2D, value: StyleArg, _: *Execution) !void {
    self.syncCanvasDimensions();
    switch (value) {
        .string => |s| {
...
pub fn getGlobalAlpha(self: *OffscreenCanvasRenderingContext2D) f64 {
    self.syncCanvasDimensions();
...
pub fn getFont(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._font;
}

pub fn setFont(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString, exec: *Execution) !void {
    self.syncCanvasDimensions();
...
pub fn getGlobalCompositeOperation(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._global_composite_operation;
}

pub fn setGlobalCompositeOperation(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
...
pub fn getLineWidth(self: *OffscreenCanvasRenderingContext2D) f64 {
    self.syncCanvasDimensions();
...
pub fn getLineCap(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._line_cap;
}

pub fn setLineCap(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
...
pub fn getLineJoin(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._line_join;
}

pub fn setLineJoin(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
...
pub fn getMiterLimit(self: *OffscreenCanvasRenderingContext2D) f64 {
    self.syncCanvasDimensions();
    return self._miter_limit;
}

pub fn setMiterLimit(self: *OffscreenCanvasRenderingContext2D, value: f64) void {
    self.syncCanvasDimensions();
    if (!std.math.isFinite(value) or value <= 0) return;
...
pub fn getTextAlign(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._text_align;
}

pub fn setTextAlign(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
...
pub fn getTextBaseline(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._text_baseline;
}

pub fn setTextBaseline(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
...
pub fn getDirection(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._direction;
}

pub fn setDirection(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
...
pub fn getFontKerning(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._font_kerning;
}

pub fn setFontKerning(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
...
pub fn getFontStretch(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._font_stretch;
}

pub fn setFontStretch(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
    inline for (.{
...
pub fn getFontVariantCaps(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._font_variant_caps;
}

pub fn setFontVariantCaps(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
    inline for (.{
...
pub fn getTextRendering(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._text_rendering;
}

pub fn setTextRendering(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
...
pub fn getImageSmoothingQuality(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._image_smoothing_quality;
}

pub fn setImageSmoothingQuality(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
...
pub fn getShadowColor(self: *OffscreenCanvasRenderingContext2D, exec: *Execution) ![]const u8 {
    self.syncCanvasDimensions();
    var writer = std.Io.Writer.Allocating.init(exec.call_arena);
...
pub fn setShadowColor(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString) void {
    self.syncCanvasDimensions();
    self._shadow_color = color.RGBA.parseFloat(value.value) catch self._shadow_color;
    self.pushShadow();
}

pub fn getImageSmoothingEnabled(self: *OffscreenCanvasRenderingContext2D) bool {
    self.syncCanvasDimensions();
    return self._image_smoothing_enabled;
}

pub fn setImageSmoothingEnabled(self: *OffscreenCanvasRenderingContext2D, value: bool) void {
    self.syncCanvasDimensions();
    self._image_smoothing_enabled = value;
}

pub fn getShadowOffsetX(self: *OffscreenCanvasRenderingContext2D) f64 {
    self.syncCanvasDimensions();
    return self._shadow_offset_x;
}

pub fn setShadowOffsetX(self: *OffscreenCanvasRenderingContext2D, value: f64) void {
    self.syncCanvasDimensions();
...
pub fn getShadowOffsetY(self: *OffscreenCanvasRenderingContext2D) f64 {
    self.syncCanvasDimensions();
    return self._shadow_offset_y;
}

pub fn setShadowOffsetY(self: *OffscreenCanvasRenderingContext2D, value: f64) void {
    self.syncCanvasDimensions();
    if (std.math.isFinite(value)) {
...
pub fn getShadowBlur(self: *OffscreenCanvasRenderingContext2D) f64 {
    self.syncCanvasDimensions();
    return self._shadow_blur;
}

pub fn setShadowBlur(self: *OffscreenCanvasRenderingContext2D, value: f64) void {
    self.syncCanvasDimensions();
...
fn pushShadow(self: *OffscreenCanvasRenderingContext2D) void {
    if (self.backend()) |owned| {
...
pub fn getLineDashOffset(self: *OffscreenCanvasRenderingContext2D) f64 {
    self.syncCanvasDimensions();
    return self._line_dash_offset;
}

pub fn setLineDashOffset(self: *OffscreenCanvasRenderingContext2D, value: f64) void {
    self.syncCanvasDimensions();
    if (std.math.isFinite(value)) {
...
pub fn createImageData(
    ...
    return ImageData.createForCanvas(args, .offscreen, exec);
}
...
pub fn putImageData(
    ...
    self.syncCanvasDimensions();
    const dx = try ImageData.canvasLong(args[1], .offscreen, "putImageData", exec);
    const dy = try ImageData.canvasLong(args[2], .offscreen, "putImageData", exec);

    const converted_dirty: ?[4]i32 = if (args.len >= 7) .{
        try ImageData.canvasLong(args[3], .offscreen, "putImageData", exec),
        try ImageData.canvasLong(args[4], .offscreen, "putImageData", exec),
        try ImageData.canvasLong(args[5], .offscreen, "putImageData", exec),
        try ImageData.canvasLong(args[6], .offscreen, "putImageData", exec),
    } else null;
...
pub fn createLinearGradient(self: *OffscreenCanvasRenderingContext2D, args: []const js.Value, exec: *Execution) !*CanvasGradient {
    _ = self;
...
pub fn createRadialGradient(self: *OffscreenCanvasRenderingContext2D, args: []const js.Value, exec: *Execution) !*CanvasGradient {
    _ = self;
...
pub fn createConicGradient(self: *OffscreenCanvasRenderingContext2D, args: []const js.Value, exec: *Execution) !*CanvasGradient {
    _ = self;
...
pub fn getFilter(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._filter;
}

pub fn setFilter(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString, exec: *Execution) !void {
    self.syncCanvasDimensions();
...
pub fn getLetterSpacing(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._letter_spacing;
}

pub fn setLetterSpacing(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString, exec: *Execution) !void {
    self.syncCanvasDimensions();
    self._letter_spacing = try exec.dupeString(std.mem.trim(u8, value.value, " \t\r\n"));
}

pub fn getWordSpacing(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._word_spacing;
}

pub fn setWordSpacing(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString, exec: *Execution) !void {
    self.syncCanvasDimensions();
    self._word_spacing = try exec.dupeString(std.mem.trim(u8, value.value, " \t\r\n"));
}

pub fn getLang(self: *OffscreenCanvasRenderingContext2D) []const u8 {
    self.syncCanvasDimensions();
    return self._lang;
}

pub fn setLang(self: *OffscreenCanvasRenderingContext2D, value: js.DOMString, exec: *Execution) !void {
    self.syncCanvasDimensions();
...
pub fn getImageData(
    ...
    self.syncCanvasDimensions();
    const sx_arg = try ImageData.canvasLong(sx_value, .offscreen, "getImageData", exec);
    const sy_arg = try ImageData.canvasLong(sy_value, .offscreen, "getImageData", exec);
    const sw = try ImageData.canvasLong(sw_value, .offscreen, "getImageData", exec);
    const sh = try ImageData.canvasLong(sh_value, .offscreen, "getImageData", exec);
    ...
    // A context first created on a zero-sized OffscreenCanvas has no backing
    // yet. Resizing it to positive dimensions must materialize that backing
    // before readback; this is observable for alpha:false (opaque black).
...
fn snapshotState(self: *const OffscreenCanvasRenderingContext2D) SavedState {
    return .{
...
fn applyState(self: *OffscreenCanvasRenderingContext2D, state: SavedState) void {
...
pub fn getLineDash(self: *OffscreenCanvasRenderingContext2D) []const f64 {
    self.syncCanvasDimensions();
    return self._line_dash;
}

pub fn setLineDash(self: *OffscreenCanvasRenderingContext2D, raw: js.Value, exec: *Execution) !void {
    const segments = try CanvasLineDash.parse(raw, .offscreen, exec);
    self.syncCanvasDimensions();
...
pub fn getContextAttributes(self: *OffscreenCanvasRenderingContext2D) ContextOptions.Attributes {
    self.syncCanvasDimensions();
    return self._context_attributes;
}

pub fn isContextLost(self: *OffscreenCanvasRenderingContext2D) bool {
    self.syncCanvasDimensions();
    return if (self._canvas.surface()) |surface| surface.isLost() else false;
}

pub fn reset(self: *OffscreenCanvasRenderingContext2D) !void {
    self.syncCanvasDimensions();
...
pub fn scale(self: *OffscreenCanvasRenderingContext2D, sx_value: js.Value, sy_value: js.Value, exec: *Execution) !void {
...
pub fn rotate(self: *OffscreenCanvasRenderingContext2D, radians: f64) void {
    self.syncCanvasDimensions();
...
pub fn translate(self: *OffscreenCanvasRenderingContext2D, dx: f64, dy: f64) void {
    self.syncCanvasDimensions();
...
pub fn setTransform(
    ...
    const matrix: [6]f64 = if (present <= 1)
        try CanvasMatrix2DInit.parse(first, .offscreen, "setTransform", exec)
    else blk: {
        if (present < 6) {
...
pub fn getTransform(self: *OffscreenCanvasRenderingContext2D, exec: *Execution) !*DOMMatrix {
    self.syncCanvasDimensions();
    const m = self._ctm;
...
pub fn arc(self: *OffscreenCanvasRenderingContext2D, x: f64, y: f64, radius: f64, start: f64, end: f64, ccw: ?bool, exec: *Execution) !void {
    self.syncCanvasDimensions();
    if (!std.math.isFinite(x) or !std.math.isFinite(y) or
...
pub fn ellipse(self: *OffscreenCanvasRenderingContext2D, x: f64, y: f64, rx: f64, ry: f64, rotation: f64, start: f64, end: f64, ccw: ?bool, exec: *Execution) !void {
    self.syncCanvasDimensions();
    if (!std.math.isFinite(x) or !std.math.isFinite(y) or
...
pub fn arcTo(self: *OffscreenCanvasRenderingContext2D, x1: f64, y1: f64, x2: f64, y2: f64, radius: f64, exec: *Execution) !void {
    self.syncCanvasDimensions();
...
pub fn roundRect(self: *OffscreenCanvasRenderingContext2D, x: f64, y: f64, width: f64, height: f64, radii: ?js.Value, exec: *Execution) !void {
    self.syncCanvasDimensions();
    const corners = (try CanvasRadii.parse(radii, .offscreen, exec)) orelse return;
    if (!std.math.isFinite(x) or !std.math.isFinite(y) or
...
pub fn fill(self: *OffscreenCanvasRenderingContext2D, fill_rule: ?js.Value, exec: *Execution) !void {
    self.syncCanvasDimensions();
    const rule = try CanvasFillRule.parse(fill_rule, .offscreen, "fill", exec);
    if (self.backend()) |owned| {
        const surface = self._canvas.surface() orelse return;
        try self.pushFillStyle(owned, surface);
...
pub fn clip(self: *OffscreenCanvasRenderingContext2D, fill_rule: ?js.Value, exec: *Execution) !void {
    self.syncCanvasDimensions();
    const rule = try CanvasFillRule.parse(fill_rule, .offscreen, "clip", exec);
...
pub fn fillText(self: *OffscreenCanvasRenderingContext2D, text: []const u8, x: f64, y: f64, _: ?f64, exec: *Execution) !void {
    self.syncCanvasDimensions();
...
pub fn measureText(self: *OffscreenCanvasRenderingContext2D, text: []const u8, exec: *Execution) !*TextMetrics {
    self.syncCanvasDimensions();
    var width: f64 = 0;
...
pub fn isPointInPath(self: *OffscreenCanvasRenderingContext2D, x: f64, y: f64, fill_rule: ?js.Value, exec: *Execution) !bool {
    self.syncCanvasDimensions();
    const rule = try CanvasFillRule.parse(fill_rule, .offscreen, "isPointInPath", exec);
...
pub fn isPointInStroke(self: *OffscreenCanvasRenderingContext2D, x: f64, y: f64) bool {
    self.syncCanvasDimensions();
    if (!std.math.isFinite(x) or !std.math.isFinite(y)) return false;
    const owned = self.backend() orelse return false;
...
pub fn drawFocusIfNeeded(_: *OffscreenCanvasRenderingContext2D, _: js.Value) void {}
...
pub const JsApi = struct {
    ...
    pub const direction = bridge.accessor(OffscreenCanvasRenderingContext2D.getDirection, OffscreenCanvasRenderingContext2D.setDirection, .{});
    pub const fontKerning = bridge.accessor(OffscreenCanvasRenderingContext2D.getFontKerning, OffscreenCanvasRenderingContext2D.setFontKerning, .{});
    pub const fontStretch = bridge.accessor(OffscreenCanvasRenderingContext2D.getFontStretch, OffscreenCanvasRenderingContext2D.setFontStretch, .{});
    pub const fontVariantCaps = bridge.accessor(OffscreenCanvasRenderingContext2D.getFontVariantCaps, OffscreenCanvasRenderingContext2D.setFontVariantCaps, .{});
    pub const textRendering = bridge.accessor(OffscreenCanvasRenderingContext2D.getTextRendering, OffscreenCanvasRenderingContext2D.setTextRendering, .{});
    ...
    pub const imageSmoothingQuality = bridge.accessor(OffscreenCanvasRenderingContext2D.getImageSmoothingQuality, OffscreenCanvasRenderingContext2D.setImageSmoothingQuality, .{});
    ...
    pub const shadowColor = bridge.accessor(OffscreenCanvasRenderingContext2D.getShadowColor, OffscreenCanvasRenderingContext2D.setShadowColor, .{});
    ...
    pub const imageSmoothingEnabled = bridge.accessor(OffscreenCanvasRenderingContext2D.getImageSmoothingEnabled, OffscreenCanvasRenderingContext2D.setImageSmoothingEnabled, .{});
    pub const shadowOffsetX = bridge.accessor(OffscreenCanvasRenderingContext2D.getShadowOffsetX, OffscreenCanvasRenderingContext2D.setShadowOffsetX, .{});
    pub const shadowOffsetY = bridge.accessor(OffscreenCanvasRenderingContext2D.getShadowOffsetY, OffscreenCanvasRenderingContext2D.setShadowOffsetY, .{});
    pub const shadowBlur = bridge.accessor(OffscreenCanvasRenderingContext2D.getShadowBlur, OffscreenCanvasRenderingContext2D.setShadowBlur, .{});
    ...
    pub const lineDashOffset = bridge.accessor(OffscreenCanvasRenderingContext2D.getLineDashOffset, OffscreenCanvasRenderingContext2D.setLineDashOffset, .{});
    pub const filter = bridge.accessor(OffscreenCanvasRenderingContext2D.getFilter, OffscreenCanvasRenderingContext2D.setFilter, .{});
    pub const letterSpacing = bridge.accessor(OffscreenCanvasRenderingContext2D.getLetterSpacing, OffscreenCanvasRenderingContext2D.setLetterSpacing, .{});
    pub const wordSpacing = bridge.accessor(OffscreenCanvasRenderingContext2D.getWordSpacing, OffscreenCanvasRenderingContext2D.setWordSpacing, .{});
    pub const lang = bridge.accessor(OffscreenCanvasRenderingContext2D.getLang, OffscreenCanvasRenderingContext2D.setLang, .{});
    ...
    pub const createPattern = bridge.function(OffscreenCanvasRenderingContext2D.createPattern, .{ .required_args = 2 });
    pub const drawFocusIfNeeded = bridge.function(OffscreenCanvasRenderingContext2D.drawFocusIfNeeded, .{});
    ...
    pub const getImageData = bridge.function(OffscreenCanvasRenderingContext2D.getImageData, .{ .required_args = 4 });
    pub const getLineDash = bridge.function(OffscreenCanvasRenderingContext2D.getLineDash, .{});
    pub const getTransform = bridge.function(OffscreenCanvasRenderingContext2D.getTransform, .{});
    pub const isContextLost = bridge.function(OffscreenCanvasRenderingContext2D.isContextLost, .{});
    pub const isPointInPath = bridge.function(OffscreenCanvasRenderingContext2D.isPointInPath, .{ .required_args = 2 });
    pub const isPointInStroke = bridge.function(OffscreenCanvasRenderingContext2D.isPointInStroke, .{ .required_args = 2 });
    pub const measureText = bridge.function(OffscreenCanvasRenderingContext2D.measureText, .{});
    pub const reset = bridge.function(OffscreenCanvasRenderingContext2D.reset, .{});
    pub const setLineDash = bridge.function(OffscreenCanvasRenderingContext2D.setLineDash, .{ .required_args = 1 });
    pub const strokeText = bridge.function(OffscreenCanvasRenderingContext2D.strokeText, .{});

    pub const arc = bridge.function(OffscreenCanvasRenderingContext2D.arc, .{ .required_args = 5 });
    pub const arcTo = bridge.function(OffscreenCanvasRenderingContext2D.arcTo, .{ .required_args = 5 });
    ...
    pub const ellipse = bridge.function(OffscreenCanvasRenderingContext2D.ellipse, .{ .required_args = 7 });
    ...
    pub const roundRect = bridge.function(OffscreenCanvasRenderingContext2D.roundRect, .{ .required_args = 4 });
    pub const save = bridge.function(OffscreenCanvasRenderingContext2D.save, .{});
    pub const scale = bridge.function(OffscreenCanvasRenderingContext2D.scale, .{ .required_args = 2 });
    pub const setTransform = bridge.function(OffscreenCanvasRenderingContext2D.setTransform, .{ .arity = 0 });
    ...
    pub const transform = bridge.function(OffscreenCanvasRenderingContext2D.transform, .{ .required_args = 6 });
