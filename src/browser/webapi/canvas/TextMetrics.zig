...
/// Read-only measurement result of CanvasRenderingContext2D.measureText.
/// width is the shaped advance (DirectWrite whole-string advance for Latin);
/// the box metrics follow Chromium's TextMetrics fields (0 until the font
/// metrics pipeline is wired).
