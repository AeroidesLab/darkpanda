...
pub const JsApi = struct {
    ...
    pub const trace = bridge.function(Console.trace, .{ .variadic = true });
    pub const debug = bridge.function(Console.debug, .{ .variadic = true });
    pub const info = bridge.function(Console.info, .{ .variadic = true });
    pub const log = bridge.function(Console.log, .{ .variadic = true });
    pub const warn = bridge.function(Console.warn, .{ .variadic = true });
    pub const clear = bridge.function(Console.clear, .{ .noop = true });
    pub const assert = bridge.function(Console.assert, .{ .arity = 0, .required_args = 0, .variadic = true });
    pub const @"error" = bridge.function(Console.@"error", .{ .variadic = true });
    pub const exception = bridge.function(Console.@"error", .{ .variadic = true });
    ...
    pub const group = bridge.function(Console.group, .{ .variadic = true });
    pub const groupCollapsed = bridge.function(Console.groupCollapsed, .{ .variadic = true });
