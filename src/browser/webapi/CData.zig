...
pub const JsApi = struct {
    ...
    pub const before = bridge.function(CData.before, .{ .ce_reactions = true, .variadic = true });
    pub const after = bridge.function(CData.after, .{ .ce_reactions = true, .variadic = true });
    pub const replaceWith = bridge.function(CData.replaceWith, .{ .ce_reactions = true, .variadic = true });
